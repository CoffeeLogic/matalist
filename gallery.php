    ...
    <div class="rslt__fltr ui-nav-menu state--expanded" js-ui-menu>
      ...
      <form action='gallery.php' method='GET'>
        ...
        <li
          ...
          <input type="submit" value="Submit" class="headerbtn">
      
          <a href="gallery.php" class="headerbtn">Reset</a>
        ...
        if(isset($_SESSION["uid"]))//IF LOGGED IN DISPLAY*************
          {
            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
              echo "SQL statement failed!3452345345";
            } else {
